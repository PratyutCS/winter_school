        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/presentation" className={`text-[#2e2a30]/70 hover:text-[#7c3aed] transition-colors duration-300 ${location.pathname === '/presentation' ? 'text-[#7c3aed]' : ''}`}>Presentation</Link></li>
