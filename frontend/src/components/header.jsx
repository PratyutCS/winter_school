        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 ml-auto sm:ml-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center space-x-2 px-2 sm:px-4 py-1.5
                         rounded-full bg-white/80 backdrop-blur-sm
                         border border-[#7c3aed]/20 shadow-md
                         transition-all duration-500 ease-out
                         hover:bg-gradient-to-r hover:from-[#7c3aed]/10 hover:to-[#ec4899]/10
                         hover:border-[#7c3aed]/50 hover:shadow-[0_0_25px_rgba(124,58,237,0.4)]
